...
Scenario: JobPlacement icon should be visible to Guest User 
...
Scenario: Guest user can able to go on Job Placement page 
    Given Guest user is in homepage
    When  Guest user see and clicked on service icon 
    Then job placement icon should be visible  to Guest users in services drop down 
...
Scenario: Guest user should  able to see submission form page 
    Given Guest user is in homepage
    When  Guest user see and clicked on service icon 
    Then job placement icon should be visible  to Guest users in services drop down 
    When Guest user clicked on Job Placement icon in services drop down 
   ...
   #Scenario: when Guest Users left all the mandatory feilds blank intentionally and tries to  click submit button 
     #
    #Given Guest user is in homepage
    #When  Guest user see and clicked on service icon 
    #Then job placement icon should be visible  to Guest users in services drop down
    ...
    #And  Guest user clicked the Apply Now button
    #Then  Guest user should be directed towards submission form page 
    #And All contact information fields  should be visible to Guest user  on submission form.
