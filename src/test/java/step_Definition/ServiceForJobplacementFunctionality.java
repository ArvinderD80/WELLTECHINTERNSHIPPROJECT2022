...
public class ServiceForJobplacementFunctionality extends Mainclass {
          ...
          @When("Guest user see and clicked on service icon")
          public void guest_user_see_and_clicked_on_service_icon() {
        	  
        	  hp.clickingServicetxt();
          ...
          @When("Guest user clicked on Job Placement icon in services drop down")
          public void guest_user_clicked_on_job_placement_icon_in_services_drop_down() {
        		 hp.clickingJobPlacementtxt();
            ...
            @When("Guest user scrolls up the jobplacement page")
            public void guest_user_scrolls_up_the_jobplacement_page() {
            	                                jpp.scrolldownthepage();
            }
            @And("Guest user clicked the Apply Now button")
            public void guest_user_clicked_the_apply_now_button() {
            	                         jpp.clickingApplyNowtxtlink();
                ...
                @Then("All contact information fields  should be visible to Guest user  on submission form.")
                public void all_contact_information_fields_should_be_visible_to_guest_user_on_submission_form() {
...
//                @When("Guest user click on lastname textbox field")
//                public void guest_user_click_on_lastname_textbox_field() {
//            	                        sb.clickinglasttxtnamefield();
...
//            	   explicitWait.until(ExpectedConditions.elementToBeClickable(sb.submitbuttn));
            	                                  sb.clickingsubmitbuttn();
            	            Assert.assertTrue(sb.submitbuttnisclickable());
               }

               @Then("Guest user should not be registerd and see errors under all  mandatory fields")
...
//
//               @When("Guest user click on lastname textbox field")
//               public void guest_user_click_on_lastname_textbox_field()  throws InterruptedException {
